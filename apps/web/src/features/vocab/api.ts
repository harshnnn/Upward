...
export const vocabApi = {
  ...
  getWord: (id: string) => apiClient.get(`/vocab/words/${id}`).then((r) => r.data),
  addMeaning: (id: string, payload: any) => apiClient.post(`/vocab/words/${id}/meanings`, payload).then((r) => r.data),
